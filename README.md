...
For more information about supported storage types, see [Storage overview | Storage | OpenShift Container Platform 4.10](https://docs.openshift.com/container-platform/4.14/welcome/index.html).
